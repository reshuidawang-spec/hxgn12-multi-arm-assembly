...
**当前版本：** 无柜门、开口朝上、无圆台的八机械臂场景，30动作/68规划点、schema36。支持标准三柜流水及四柜混流：空柜从7.5米西侧上料带按1.5米安全节距排队，J2 可选黑色简化配方并复用现有 TCP；公共区1/2/3可同时执行不同柜体任务，同一公共区仍保持单臂互斥。
